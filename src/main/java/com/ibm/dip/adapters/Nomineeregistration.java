...
@Component
public class Nomineeregistration implements JavaDelegate{

    @Autowired
    private Utility utility;

    @Autowired
    private NomineeRegistrationRestProcessor restProcessor;

    private final static Logger LOGGER = Logger.getLogger(Nomineeregistration.class.getName());
    ...
    public void execute(DelegateExecution execution) throws Exception {
         ...
         if(response instanceof ApiError ||  response instanceof GenericError){
            //Failure Path
            throw new RuntimeException("Error occurred in the adapter:"+Nomineeregistration.class.getName());
         }else{
