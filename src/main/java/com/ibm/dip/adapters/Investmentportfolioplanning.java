...
@Component
public class Investmentportfolioplanning implements JavaDelegate{

    @Autowired
    private Utility utility;

    @Autowired
    private InvestmentPortfolioPlanningRestProcessor restProcessor;

    private final static Logger LOGGER = Logger.getLogger(Investmentportfolioplanning.class.getName());
    ...
    public void execute(DelegateExecution execution) throws Exception {
         ...
         if(response instanceof ApiError ||  response instanceof GenericError){
            //Failure Path
            throw new RuntimeException("Error occurred in the adapter:"+Investmentportfolioplanning.class.getName());
         }else{
