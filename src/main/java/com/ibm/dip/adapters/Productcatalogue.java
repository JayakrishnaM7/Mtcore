...
@Component
public class Productcatalogue implements JavaDelegate{

    @Autowired
    private Utility utility;

    @Autowired
    private ProductCatalogueRestProcessor restProcessor;

    private final static Logger LOGGER = Logger.getLogger(Productcatalogue.class.getName());
    ...
    public void execute(DelegateExecution execution) throws Exception {
         ...
         if(response instanceof ApiError ||  response instanceof GenericError){
            //Failure Path
            throw new RuntimeException("Error occurred in the adapter:"+Productcatalogue.class.getName());
         }else{
